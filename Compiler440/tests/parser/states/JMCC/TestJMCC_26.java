...
public class TestJMCC_26 {
    ...
    /**
     * Tests invalid state for JMCC_26
    ...
    public void testInvalidState() throws ParserException
    {
        ...
        Token token = new Token(TokenTypes.OP6, tokens);
        ...
        assertEquals(parser.getCurrentState().getClass(), new JMCC_24().getClass());
    }
